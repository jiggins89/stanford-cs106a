 ...
 * Section Leader: 
 * ---------------------------
 * This file generates the program heirachy graphic.
 */
...
public class ProgramHierarchy extends GraphicsProgram {
	...
	public void run() {
		...
		dialogProgram.setFont("Arial-15");
		// find 'x' coordinates to centre label in boxes and add label
